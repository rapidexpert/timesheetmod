...
var Droppables = {
    ...
    {
        return (
                (drop.element != element) && ((!drop._containers) || this.isContained(element, drop)) && ((!drop.accept)
    ...
    initDrag: function(event)
    {
        ...
        if (Event.isLeftClick(event))
        {
            ...
            if ((tag_name = src.tagName.toUpperCase()) && (
                    tag_name == 'INPUT' || tag_name == 'SELECT' || tag_name == 'OPTION' || tag_name == 'BUTTON'
    ...
    mark: function(dropon, position)
    {
        ...
        if (!Sortable._marker)
        {
            Sortable._marker = ($('dropmarker')
                    || Element.extend(document.createElement('DIV'))).hide().addClassName('dropmarker').setStyle({position:'absolute'});
