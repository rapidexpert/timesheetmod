...
{
    return '"' + this.getUTCFullYear() + '-' + (this.getUTCMonth() + 1).toPaddedString(2) + '-'
            + this.getUTCDate().toPaddedString(2) + 'T' + this.getUTCHours().toPaddedString(2) + ':'
...
Ajax.Request = Class.create(Ajax.Base, {
    ...
    respondToReadyState: function(readyState)
    {
        ...
        if (state == 'Complete')
        {
            ...
            if (this.options.evalJS == 'force' || (this.options.evalJS && contentType
...
Ajax.Response = Class.create({
    ...
    _getResponseJSON: function()
    {
        ...
        if (!options.evalJSON || (options.evalJSON != 'force' && !(this.getHeader('Content-type')
                || '').include('application/json')) || this.responseText.blank())
            return null;
        try
        {
...
Element.Methods = {
    ...
    insert: function(element, insertions)
    {
        ...
        if (Object.isString(insertions) || Object.isNumber(insertions) || Object.isElement(insertions) || (insertions
        ...
        for (position in insertions)
        {
            ...
            tagName =
            ((position == 'before' || position == 'after') ? element.parentNode : element).tagName.toUpperCase();
    ...
    hasClassName: function(element, className)
    {
        ...
        return (elementClassName.length > 0 && (elementClassName == className || new RegExp("(^|\\s)" + className
        ...
        for (var property in styles)
            if (property == 'opacity') element.setOpacity(styles[property]);
                ...
                elementStyle[(property == 'float' || property == 'cssFloat') ?
                             (Object.isUndefined(elementStyle.styleFloat) ? 'cssFloat' : 'styleFloat') : property] =
                styles[property];
...
else if (Prototype.Browser.IE)
{
    ...
    $w('colSpan rowSpan vAlign dateTime accessKey tabIndex ' + 'encType maxLength readOnly longDesc').each(function(
            attr)
    {
...
document.viewport = {
    ...
    {
        return Element._returnOffset(window.pageXOffset || document.documentElement.scrollLeft
                || document.body.scrollLeft, window.pageYOffset || document.documentElement.scrollTop
    ...
    serializeElements: function(elements, options)
    {
        ...
        var data = elements.inject({ }, function(result, element)
        {
            if (!element.disabled && element.name)
            {
                ...
                if (value != null && (element.type != 'submit' || (!submitted && submit !== false && (!submit || key
...
Abstract.TimedObserver = Class.create(PeriodicalExecuter, {
    ...
    execute: function()
    {
        ...
        if (Object.isString(this.lastValue) && Object.isString(value) ? this.lastValue != value :
...
var Position = {
    ...
    within: function(element, x, y)
    {
        ...
        return (y >= this.offset[1] && y < this.offset[1] + element.offsetHeight && x >= this.offset[0] && x
    ...
    withinIncludingScrolloffsets: function(element, x, y)
    {
        ...
        return (this.ycomp >= this.offset[1] && this.ycomp < this.offset[1] + element.offsetHeight && this.xcomp
                >= this.offset[0] && this.xcomp < this.offset[0] + element.offsetWidth);
    },
...
if (!document.getElementsByClassName) document.getElementsByClassName = function(instanceMethods)
{
    ...
    } : function(element, className)
    {
        ...
        {
            if (child.className && (cn = ' ' + child.className + ' ') && (cn.include(className) || (classNames
